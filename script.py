...
if __name__ == '__main__':
    ...
    with open(os.devnull, "w") as fnull:
        p = subprocess.Popen(["Xvfb", "-ac", "-screen", "0", "1920x1080x24"],
                             stdout=fnull, stderr=fnull, close_fds=True)
    ...
    with open(os.devnull, "w") as fnull:
        p1 = subprocess.Popen(["fluxbox", "-screen", "0"],
                             stdout=fnull, stderr=fnull, close_fds=True)
    ...
    p2 = subprocess.Popen(["ffmpeg", "-video_size", "1720x880", "-framerate", "25", "-f", "x11grab", "-i", ":0.0+100,200", "/opt/wd/output.mp4"],
                             close_fds=False)
